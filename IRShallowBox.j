...
@implementation IRShallowBox : IRStyledView {
...
- (IRBeigeBox) initWithFrame:(CGRect)aFrame {
	...
	[backgroundView setBackgroundNinePartPatternImageNamed:@"IRShallowBox.backdrop" sliceTop:24 right:24 bottom:24 left:24 sender:IRBeigeBox];
